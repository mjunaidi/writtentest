WrittenTest training plugin
===========================
This is a very simple Polopoly plugin example. It intends to illustrate
...
Note that this is only a mockup, and contains no real functionality.
